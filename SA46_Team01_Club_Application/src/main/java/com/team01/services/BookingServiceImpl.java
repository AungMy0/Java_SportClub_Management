...
public class BookingServiceImpl implements BookingService {
	...
	@Override
	@Transactional
	public Booking findBookingByEID(@Param("eid") Integer eid) {
		
		return bookingRepo.findBookingByEID(eid);
	...
	@Override
	public ArrayList<Booking> findBookingByMID(@Param("eid") Integer eid){
		
		return bookingRepo.findBookingByMID(eid);
	};
	
	@Override
	public ArrayList<Booking> findcancelBooking( Date startdate, Date enddate){
		return bookingRepo.findcancelBooking(startdate, enddate);
