...
public class MemberController {
	...
	//////////////// userprofile/////////
	@RequestMapping(value = "/useredit/{memberno}", method = RequestMethod.GET)
	public ModelAndView editdUserPag(@PathVariable Integer memberno) {
	...
	public ModelAndView updateprofile(@ModelAttribute @Valid Member member, BindingResult result,
			final RedirectAttributes redirectAttributes) {
		mService.updateMember(member);
	...
	@RequestMapping(value = "/useredit/{memberno}", method = RequestMethod.POST)
	public ModelAndView editUserStuden(@ModelAttribute @Valid Member member, @PathVariable String memberno,
			final RedirectAttributes redirectAttributes) {
		mService.updateMember(member);
	...
	public ModelAndView profilePage(HttpServletRequest req) {
		...
		ModelAndView mav = new ModelAndView("userProfile", "member", new Member());
		Member searchedMember = mService.findMember(value);
		mav.addObject("member", searchedMember);
		ArrayList<Booking> bookingList = bService.findBookingByMID(value);
